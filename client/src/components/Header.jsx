...
const header = () => {
  ...
  return (
    ...
    <div className='flex flex-wrap justify-center mt-16 gap-3'>
        ...
        <img className='rouunded hover:scale-105 transition-all duration-300 cursor-pointer max-sm:w-10' src={index%2==0 ? assets.sample_img_2 : assets.sample_img_1} alt="" key={index} width={70}/>
        ))}
    </div>
